                        ...
                        <div className="card">
                            ...
                            <div className="card-body">
                                <form action="process_delete.php" method="post">
                                    <p className="card-text">Bạn có chắc muốn xóa bài viết này?</p>
                                    <div className="text-center">
                                        <div className="btn-group mt-3" role="group">
                                            <button type="submit" className="btn btn-success mr-2" name="confirm" value="yes">Có, xóa bài viết</button>
