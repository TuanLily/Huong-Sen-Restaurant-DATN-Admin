...
export default function ProductImageDetailDelete () {
    return (
            ...
            <div className="page-inner">
                <div className="row">
                    <form className="col-md-12">
                        <div className="card">
                            <h5 className="card-header">Xác nhận xóa ảnh sản phẩm</h5>
                            <div className="card-body">
                                <form action="process_delete.php" method="post">
                                    <p className="card-text">Bạn có chắc muốn xóa ảnh này?</p>
